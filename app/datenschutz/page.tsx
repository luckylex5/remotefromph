  ...
  return (
    <div style={{ maxWidth: '860px', margin: '0 auto', padding: '64px 24px 96px' }}>
      ...
      <div style={{ borderTop: '1px solid var(--rule)', paddingTop: '48px', display: 'flex', flexDirection: 'column', gap: '40px' }}>
        ...
        <section>
          <p className="label" style={{ marginBottom: '12px' }}>1. RESPONSIBLE PARTY (CONTROLLER)</p>
        ...
        <section style={{ borderTop: '1px solid var(--rule)', paddingTop: '40px' }}>
          ...
          <p style={{ color: 'var(--ink)', lineHeight: 1.7, margin: '0 0 16px' }}>
            <strong style={{ color: 'var(--white)' }}>Server logs:</strong> When you visit this website, our hosting provider (Vercel Inc., 340 Pine Street, Suite 801, San Francisco, CA 94104, USA) automatically collects standard server log data, including your IP address, browser type, referring URL, and time of visit. This data is used solely for technical operation and security purposes and is deleted after 30 days.
          </p>
          <p style={{ color: 'var(--ink)', lineHeight: 1.7, margin: 0 }}>
            <strong style={{ color: 'var(--white)' }}>Newsletter subscription:</strong> If you subscribe to our newsletter, we store your email address. This data is stored in Supabase (Supabase Inc., 970 Toa Payoh North, Singapore) and is used solely to send you editorial updates. You can unsubscribe at any time by contacting us at{' '}
            <a href="mailto:schreiber@ovao.io" style={{ color: 'var(--accent)', textDecoration: 'underline' }}>
              schreiber@ovao.io
            </a>.
          </p>
        ...
        <section style={{ borderTop: '1px solid var(--rule)', paddingTop: '40px' }}>
          ...
          <p style={{ color: 'var(--ink)', lineHeight: 1.7, margin: 0 }}>
            Processing of server logs is based on Art. 6(1)(f) GDPR (legitimate interest in secure website operation). Newsletter subscriptions are processed on the basis of Art. 6(1)(a) GDPR (your consent). You may withdraw consent at any time without affecting the lawfulness of prior processing.
          </p>
        </section>
        ...
        <section style={{ borderTop: '1px solid var(--rule)', paddingTop: '40px' }}>
          ...
          <p style={{ color: 'var(--ink)', lineHeight: 1.7, margin: '0 0 16px' }}>
            <strong style={{ color: 'var(--white)' }}>Vercel:</strong> This website is hosted on Vercel. Vercel may process data in the USA. Vercel is certified under the EU-U.S. Data Privacy Framework. See{' '}
          ...
          <p style={{ color: 'var(--ink)', lineHeight: 1.7, margin: '0 0 16px' }}>
            <strong style={{ color: 'var(--white)' }}>Supabase:</strong> Subscriber emails are stored in Supabase. See{' '}
          ...
          <p style={{ color: 'var(--ink)', lineHeight: 1.7, margin: 0 }}>
            <strong style={{ color: 'var(--white)' }}>Unsplash:</strong> Images on this site are served from Unsplash (Unsplash Inc., Canada). When images are loaded, your browser may send your IP address to Unsplash servers. See{' '}
        ...
        <section style={{ borderTop: '1px solid var(--rule)', paddingTop: '40px' }}>
          ...
          <p style={{ color: 'var(--ink)', lineHeight: 1.7, margin: 0 }}>
            Under GDPR, you have the right to access, rectify, erase, restrict, and port your personal data, as well as to object to processing. To exercise these rights, contact us at{' '}
            <a href="mailto:schreiber@ovao.io" style={{ color: 'var(--accent)', textDecoration: 'underline' }}>
              schreiber@ovao.io
            </a>. You also have the right to lodge a complaint with a supervisory authority — in Germany, this is the{' '}
            <strong style={{ color: 'var(--white)' }}>Landesbeauftragte für Datenschutz und Informationsfreiheit Nordrhein-Westfalen</strong>.
          </p>
        </section>

        <section style={{ borderTop: '1px solid var(--rule)', paddingTop: '40px' }}>
          <p className="label" style={{ marginBottom: '12px' }}>7. CHANGES TO THIS POLICY</p>
          <p style={{ color: 'var(--ink)', lineHeight: 1.7, margin: 0 }}>
            We may update this privacy policy from time to time. The current version is always available at this URL. Last updated: March 2026.
          </p>
        </section>
